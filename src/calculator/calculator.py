...
class Calculator:
    ...
    def _validate_input(self, *values):
        ...
        for value in values:
            if value > Calculator.MAX_VALUE or value < Calculator.MIN_VALUE:
                raise InvalidInputException(f"Input value {value} is outside of the valid range [{self.MIN_VALUE}, {self.MAX_VALUE}]")
